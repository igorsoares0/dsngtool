...
const FROM = process.env.LICENSE_EMAIL_FROM ?? "dsgntool <onboarding@resend.dev>";
  ...
  await resend.emails.send(
    {
      from: FROM,
      to,
      subject: "Your dsgntool license key",
      html: `
        <div style="font-family:system-ui,sans-serif;max-width:480px;margin:0 auto;padding:24px">
          <h1 style="font-size:20px;margin:0 0 12px">Thanks for your purchase 🎉</h1>
          <p style="color:#444;line-height:1.5">Here's your lifetime license key. Open dsgntool, click <strong>Upgrade / Enter license</strong>, and paste it to unlock watermark-free exports and all premium templates.</p>
